...
PDF_LABELS = {
    "en": {
        ...
        "status": L["status"],
        "findings_summary": L["findings_summary"],
        "orphan_decisions": L["orphan_decisions"],
        "blind_changes": L["blind_changes"],
        "hidden_risks": L["hidden_risks"],
        "open": "Open",
        "in_review": "In Review",
        "closed": "Closed",
        "recent_analyses": L["recent_analyses"],
        "documents": "Documents",
        "findings": "Findings",
        "governance_violation": L["governance_violation"],
